          ...
          <AnimatePresence mode="wait">
            {showSplash ? (
              ...
              >
                ...
                >
                  <div className="text-cyan-300 font-mono text-sm tracking-[0.5em] mb-4">
                    {projectNumber}
                  </div>
              ...
              >
                ...
                <nav className="sticky top-0 w-full z-50 bg-[#050505]/95 backdrop-blur-xl border-b border-white/5">
                  <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
                    <button 
                      onClick={onClose}
                      className="flex items-center gap-2 text-zinc-300 hover:text-cyan-300 transition-colors group"
                    >
                ...
                <div className="pt-20 lg:pt-32 pb-32 max-w-[90rem] mx-auto px-6 lg:px-16 w-full flex-grow">
                  ...
                  <div className="mb-16 lg:mb-24 flex flex-col gap-6 lg:gap-10">
                    ...
                    <p className="text-lg md:text-2xl lg:text-3xl text-zinc-200 font-light max-w-4xl leading-relaxed">
                      {project.desc}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                    ...
                    <div className="lg:col-span-3 flex flex-col gap-16">
                      ...
                      {/* Project Category */}
                      <div>
                        <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] mb-4">
                      ...
                      {/* Year */}
                      <div>
                        <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] mb-4">Year</h4>
                        <p className="text-base md:text-lg text-white font-medium">
                          {project.year}
                        </p>
                      </div>
                      ...
                      {/* Client */}
                      <div>
                        <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] mb-4">Client</h4>
                        <p className="text-base md:text-lg text-white font-medium">
                          {project.client}
                        </p>
                      </div>
                      ...
                      {/* Credits */}
                      <div>
                        <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] mb-4">Credits</h4>
                        <p className="text-base md:text-lg text-white font-medium">
                          {project.credits}
                        </p>
                      </div>
                    ...
                    <div className="lg:col-span-9 flex flex-col gap-20">
                      ...
                      <section>
                        <div className="flex items-center gap-4 mb-6">
                          <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] whitespace-nowrap">Info</h4>
                      ...
                      <section>
                        <div className="flex items-center gap-4 mb-8">
                          <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] whitespace-nowrap">What I Did</h4>
                          <div className="h-px w-12 bg-white/10" />
                        </div>
                        ...
                        <div className="flex flex-col gap-10">
                          {project.whatIDid.map((item, index) => (
                            <div key={index} className="flex gap-6 md:gap-12 items-start">
                              <span className="text-xs md:text-sm font-mono text-zinc-300 mt-1">
                      ...
                      <section className="pt-10">
                        <div className="flex items-center gap-4 mb-10">
                          <h4 className="text-[10px] md:text-xs text-zinc-300 font-bold uppercase tracking-[0.2em] whitespace-nowrap">Stack Used</h4>
                          <div className="h-px w-12 bg-white/10" />
                        </div>
                        <div className="flex flex-wrap gap-4 max-w-3xl">
                          {project.tech.split(",").map((tech, i) => (
                            <span 
                              key={i} 
                              className="px-6 py-2.5 rounded-full border border-white/5 bg-white/[0.02] text-cyan-300 text-xs md:text-sm font-bold tracking-wide font-[Arial,Helvetica,sans-serif] hover:bg-white/[0.05] hover:border-white/20 transition-all cursor-default"
                            >
                              {tech.trim()}
                            </span>
                          ))}
                  ...
                  <section className="mt-8 pt-24 border-t border-white/5 relative w-full bg-[#050505] pb-24 px-6 md:px-12">
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-zinc-200 hover:text-white transition-colors duration-500">
                          Project
                        </span>
                      </motion.div>
                    </button>
                    ...
                    <div className="mt-32 flex flex-col items-start gap-10">
                      <h4 className="text-xs tracking-[0.5em] text-zinc-200 uppercase">
                        LET&apos;S WORK TOGETHER
                      </h4>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 text-xs md:text-xs font-medium font-[Arial,Helvetica,sans-serif]">
                        <a
                          ...
                          className="tracking-[0.25em] text-zinc-200 hover:text-cyan-300 transition-colors"
                        >
                          EMAIL
                        </a>
